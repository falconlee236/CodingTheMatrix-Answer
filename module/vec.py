...
def scalar_mul(v, alpha):
    ...
    True
    """
    return Vec(v.D, {x: getitem(v, x) * alpha for x in v.D})
...
def neg(v):
    ...
    True
    """
    return Vec(v.D, {x: getitem(v, x) * -1 for x in v.D})
